...
// в любой из таблиц переписки, поэтому ищем по очереди; а ещё через
...
// purchase_emails (переписка по закупке) из списка убрана вместе с самой
// сущностью Purchase в шаге 11b плана закупок — таблица была пуста.
const EMAIL_TABLES = ['supplier_offer_emails', 'work_contractor_emails', 'mailbox_emails'];
