// Публичная ссылка на планировку/бронирование (/plan/:token) — тот же
...
// "index, follow" из статики. Клиентская ссылка на конкретную бронь лида —
// рассылается в мессенджеры/почту, в поиске быть не должна.
import { readFileSync, writeFileSync } from 'node:fs';

const TITLE = 'Планировка и бронирование';
const DESCRIPTION = 'Планировка этажа, статусы кабинетов и бронирование рабочего места';
...
html = html
  ...
  .replace(/(<meta property="og:url" content=")[^"]*(")/, `$1https://redevelopment.pro/plan$2`)
...
writeFileSync('dist/plan.html', html);
