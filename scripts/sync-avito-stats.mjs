...
//
// Авторизация — через cookie сессии (как у Realt), записанную из консоли
// браузера в уже залогиненной вкладке. Если начнёт падать с 401/403 —
// cookie протухла, нужно повторить и обновить секрет AVITO_COOKIE.
//
