...
// офисы по этажу) + кладовые. Машиноместа уже посчитаны отдельно —
// одноразовый парсинг, статические агрегаты прямо в
// src/pages/DistrictGuidePage.tsx (parkingSegments/parkingAddresses),
// этот скрипт их не трогает и не дублирует.
//
