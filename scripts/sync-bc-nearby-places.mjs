...
// и рестораны делай в одну категорию»), 'кофейня'/'кофе' — в свою 'coffee'
// («давай соберем кофейни отдельно»; второй запрос добавлен 2026-09-22 —
// Яндекс режет выдачу каждого запроса примерно на 25 организациях, и часть
// кофеен всплывает только по «кофе», не по «кофейня»). Держать в паре с тем
// же списком в capture-yandex-nearby.mjs — расхождение означает разные
// наборы категорий у двух путей сбора одних и тех же данных.
