...
внутри Codex Cloud с базовой веткой `preview`, и мержит PR Codex туда же. Claude
...
на этой ветке, а не на живом сайте: `git push -f origin <ветка сессии>:preview` → стабильный адрес
