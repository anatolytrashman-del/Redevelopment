...
5. `create_pull_request` (GitHub MCP) из релизной ветки в `oodobu` — ОДИН PR
   на всю пачку, со списком, что внутри. Мерджит его владелец (или сессия по
   его явному "мерджи") — это единственный момент, когда собирается прод-билд
   Vercel.
6. После мерджа: перенести записи в "Опубликовано" в `docs/release-queue.md`,
...
и сам блокирует ("Modify Shared Resources", проверено 2026-09-12).
