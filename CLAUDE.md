...
`docs/bc-developer-cards.md` (2026-09-20: разбор карточек застройщика на
странице БЦ — что сделано/пропущено по каждой из 26 записей с известным
`developer`, критерий "нормальный застройщик", правило про негатив,
незакрытая часть — 115 БЦ вообще без указанного застройщика).
