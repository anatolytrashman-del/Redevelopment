...
// Как техзадание называется для человека — и в списке админки, и во
// вкладке браузера на публичной странице /tz/:token. Раньше в списке
// стояло название объекта с адресом ("Minsk One — Минск, Полтавская, 10"):
// объект и так виден строкой ниже, а сметчику во вкладке нужен не адрес,
// а понимание, что за документ он открыл.
export const BRIEF_TITLE = 'Техзадание на реновацию';

// Заголовки двух блоков внутри каждой категории. Не капсом и не мелким
// серым, как было ("СЕЙЧАС — ЧТО МЕНЯТЬ" / "ДОЛЖНО СТАТЬ (РЕФЕРЕНС)") —
// это основные ориентиры документа для сметчика, а не служебные подписи.
export const BEFORE_BLOCK_TITLE = 'Текущее состояние здания';
export const AFTER_BLOCK_TITLE = 'Примерный дизайн-проект';
...
// Блок в самом низу документа: расчёт нужен предварительный, и считать
// каждое помещение по отдельности необязательно — здесь заранее оговорены
// допустимые упрощения, чтобы сметчик не закладывал лишнее время.
export const COST_REDUCTION_IDEAS_TITLE = 'Идеи по сокращению срока и стоимости предварительного расчёта';
