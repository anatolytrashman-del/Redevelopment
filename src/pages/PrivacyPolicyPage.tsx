        ...
        >
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              ...
              «Принять все» в уведомлении. Изменить выбор можно в любой момент ссылкой
          ...
          <section className="flex flex-col gap-2">
            ...
            <p>
              В США не обеспечивается надлежащий уровень защиты персональных данных в смысле
              законодательства Беларуси. Это значит, что там могут действовать другие правила
              доступа к данным, в том числе у государственных органов. Мы передаём туда данные
              только с вашего согласия и только в объёме, нужном для целей из раздела 2.
            </p>
          </section>
