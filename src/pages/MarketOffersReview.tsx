...
// много запросов", владелец поймал вживую, см. журнал CLAUDE.md). Гварды
...
export function MarketOffersReview() {
  ...
  function closeEdit() {
    ...
    // CLAUDE.md). "Отмена"/крестик теперь только закрывают карточку — цель
  ...
  // словили бан по IP ("слишком много запросов", см. журнал CLAUDE.md).
