...
const DESCRIPTION =
  'Справочник по бизнес-центрам Минска на данных каталога: чем классы A, B+, B и C отличаются в цифрах, почему рынок делится на два ценовых яруса, сколько на самом деле платит арендатор, как отличить класс на осмотре и что проверить в объявлении и договоре.';
