...
export function BusinessCentersRankingBPlusPage() {
  ...
  const ranking = useMemo(() => buildRankingForClasses(centers ?? [], ['B+']), [centers]);
  const excluded = useMemo(() => buildExcludedForClasses(centers ?? [], ['B+']), [centers]);
  ...
  const faqItems = useMemo(() => {
    ...
    return items;
  }, [centers, displayed, offerIndex, ranking, excluded]);
