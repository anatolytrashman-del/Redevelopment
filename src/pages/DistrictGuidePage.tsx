...
const districtFaq: FaqItem[] = [
  {
    ...
    answer:
      'Две станции метро Зеленолужской линии — «Ковальская Слобода» и «Аэродромная», плюс 30 маршрутов наземного транспорта (14 автобусных, 8 троллейбусных, 8 маршруток), связывающих район со всеми частями Минска.',
  },
  {
