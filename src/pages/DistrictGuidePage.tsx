      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-12 sm:px-8">
        ...
        <div className={cn('flex flex-col gap-4 p-6', glassCardClass)} style={glassCardShadow}>
          ...
          <p className="text-sm text-ink-muted">
            ...
            цикла с головным офисом в Швейцарии, основанная сербскими предпринимателями Боголюбом и Драгомиром
            Каричами. На белорусском рынке холдинг работает с 2006 года: среди других проектов компании в Минске —
            «Маяк Минска», Vogue, «Вивальди» и «Рахманинов». Территорию бывшего аэропорта Минск-1 под застройку
            юрлицо компании ИООО «Дана Астра» получило по указу Президента в 2014 году. Заявленный на старте
            масштаб проекта — 320 га, около 30 тысяч квартир и порядка $3,5 млрд инвестиций.
          </p>
