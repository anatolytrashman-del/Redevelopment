...
// Черновик продающей страницы (/:slug/draft) — песочница для обкатки
// следующих правок дизайна, отдельно от уже одобренной и перенесённой на
// /:slug версии (см. ObjectLandingPage). Изменения здесь не влияют на
// боевую страницу, пока их снова не перенесут туда вручную.
