...
// Родительный падеж («+8% к медиане Центрального района») — с 2026-09-21
// сравнение со срезом рынка стоит внутри плитки сделки и пишется короче,
// чем прежнее «выше на 8% медианы по Центральному району» (дательный
// падеж вместе с той формулировкой и ушёл). Тот же принцип явной карты на
// конечное известное множество, что и у предложного падежа выше:
// окончания этих прилагательных регуляркой не выводятся.
const DISTRICT_GENITIVE: Record<string, string> = {
  Центральный: 'Центрального',
  Октябрьский: 'Октябрьского',
  Советский: 'Советского',
  Фрунзенский: 'Фрунзенского',
  Заводской: 'Заводского',
  Первомайский: 'Первомайского',
  Партизанский: 'Партизанского',
  Московский: 'Московского',
  Ленинский: 'Ленинского',
};

export function districtGenitive(district: string): string {
  return DISTRICT_GENITIVE[district] ?? district;
}
